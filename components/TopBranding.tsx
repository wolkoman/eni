...
export function TopBranding() {
    return <div className={"from-emmaus/60 to-transparent bg-gradient-to-t pt-24 md:mt-12 relative overflow-hidden"}>
        <Responsive>
            <div className="flex flex-col md:flex-row justify-around items-center">
                ...
                <div className="text-7xl self-start text-black/90 text-shadow relative">
                    ...
                    <span className="text-emmaus">am Wienerberg</span>
                </div>
