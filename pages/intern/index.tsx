  ...
  return <Site title="Mitgliedsbereich">
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-2">
      ...
      }
      {
        ...
        <Link href="intern/news"><div className="h-32 bg-gray-200 flex justify-center items-center text-lg cursor-pointer">Wochenmitteilungen</div></Link>
      }
      ...
      <div className="h-32 bg-gray-200 flex justify-center items-center text-lg cursor-pointer" onClick={logout}>Logout</div>
    </div>
  </Site>
}