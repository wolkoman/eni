  ...
  return <>
    <Section id="personal" title="Unsere Priester">
      <div className="flex flex-col lg:flex-row-reverse gap-4 items-stretch">
        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden flex-[3] flex flex-col lg:flex-row pt-8">
        ...
        <div className="flex-1 flex flex-col items-center text-center rounded-lg shadow-lg bg-white pt-8">
